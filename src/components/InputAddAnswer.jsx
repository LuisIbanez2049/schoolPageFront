...
function InputAddAnswer({ color, commentId, userIdFromComment, userName, onClickFunction, onChangeFunction, valueInput}) {
                        ...
                        <div className=' w-full flex flex-row p-2 justify-around '>
                            <div>
                                ...
                                <div className=' relative'>
                                    <label htmlFor="" className=' absolute bottom-[13px] text-red-600'> <span className=' font-semibold text-[#0000ffc0]'> <i className="fa-brands fa-threads"></i>{userName} </span> </label>
                                    <input className={`h-[50px] w-[900px] text-pretty font-light pl-[100px] pr-2 bg-transparent border-b border-[#00000071] focus:border-[${color}] focus:outline-none transition-colors peer`}
