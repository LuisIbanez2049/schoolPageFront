...
function ConfirmationPopUpAlert({ isShow, handleOnConfirmFunction, handleOnCancelFunction, message }) {
    return (
        <div className={` ${isShow ? "show" : "hidden"} fixed z-50 top-0 right-0 flex flex-row justify-center items-center  w-[100vw] h-[100vh]  z-30   bg-[#0e010125]`}>
            <div className=' flex flex-col items-center gap-4 shadow-lg sticky top-0 bg-gray-100 p-3 rounded-[20px]'>
                <h1 className='text-[18px] lg:text-[25px]'> {message} </h1>
