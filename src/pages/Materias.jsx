        ...
        <div className='flex flex-col min-h-screen bg-[#e0e2ed]'>
            <div className={`w-full flex flex-row justify-center gap-40 flex-wrap pt-[40px]`}>
                ...
                <button onClick={() => {
                    ...
                    <h1 className={`text-[25px] text-[#000000a8] font-bold ${viewMySubjects ? "bg-[#ac7033a6]" : " bg-[#efb071a6]"} p-2 border border-[#0000001f] rounded-[15px]`}>MY SUBJECTS</h1>
                </button>

                <button onClick={() => {
                    setViewMySubjects(false)
                }}>
                    <h1 className={`text-[25px] text-[#000000a8] font-bold ${viewMySubjects ? "bg-[#efb071a6]" : " bg-[#ac7033a6]"} p-2 border border-[#0000001f] rounded-[15px]`}>ALL SUBJECTS</h1>
                </button>
