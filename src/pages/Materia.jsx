                    ...
                    <div className=' relative w-full flex flex-col gap-10 justify-center '>
                        ...
                        <div className=' relative w-full overflow-hidden flex flex-col justify-center items-center'>
                            ...
                            <div className={` relative ${isMobileView ? "show" : "hidden"} relative w-full lg:w-[95%]`}>
                                ...
                                <div className={` transition-all duration-500 transform pt-[30px] ${isDesplegable ? "bg-[#00000086] z-30" : "bg-transparent z-0"} w-full min-h-screen absolute  top-0 `}
                                    onClick={() => { setIsDesplegable(false) }}>

                                    <div className={` relative w-[240px] h-[81vh] transition-all duration-500 transform ${isDesplegable ? "translate-x-[0%]" : "translate-x-[-100%]"} 
